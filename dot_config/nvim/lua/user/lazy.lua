...
local plugins = {
    ...
    require("user.plugins.gp_nvim"),
    require("user.plugins.gitsigns-nvim"),
    require("user.plugins.grug_far"),
    ...
    require("user.plugins.treewalker"),
    ...
    { "CRAG666/code_runner.nvim",  cmd = { "RunCode", "RunFile", "RunProject", "RunClose" }, config = true },
